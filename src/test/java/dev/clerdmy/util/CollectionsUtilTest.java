...
class CollectionsUtilTest {
    ...
    void binarySearchRecursion() {
        ...
        int key = 23;
        assertEquals(5, CollectionsUtil.binarySearch(key, array, comparator, true));
        key = 72;
        assertEquals(8, CollectionsUtil.binarySearch(key, array, comparator, true));
        key = 3;
        assertEquals(-1, CollectionsUtil.binarySearch(key, array, comparator, true));
        key = 100;
        assertEquals(-1, CollectionsUtil.binarySearch(key, array, comparator, true));
    }
    ...
    void lowerBoundRecursion() {
        ...
        Comparator<Integer> comparator = Integer::compare;
        int key = 23;
        assertEquals(5, CollectionsUtil.lowerBound(key, array, comparator, true));
        key = 72;
        assertEquals(8, CollectionsUtil.lowerBound(key, array, comparator, true));
        key = 3;
        assertEquals(1, CollectionsUtil.lowerBound(key, array, comparator, true));
        key = 100;
        assertEquals(Integer.MAX_VALUE, CollectionsUtil.lowerBound(key, array, comparator, true));
    }
    ...
    void upperBoundRecursion() {
        ...
        Comparator<Integer> comparator = Integer::compare;
        int key = 23;
        assertEquals(6, CollectionsUtil.upperBound(key, array, comparator, true));
        key = 72;
        assertEquals(9, CollectionsUtil.upperBound(key, array, comparator, true));
        key = 3;
        assertEquals(1, CollectionsUtil.upperBound(key, array, comparator, true));
        key = 100;
        assertEquals(Integer.MAX_VALUE, CollectionsUtil.upperBound(key, array, comparator, true));
    }
